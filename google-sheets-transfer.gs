...
function transferDataWithFormatting() {
  ...
  // Copy the range (including formatting)
...
/**
 * Function to transfer data from A1 to A2 and clear A1
 * This moves the data rather than copying it
 */
function moveDataFromA1ToA2() {
  ...
  SpreadsheetApp.getUi().alert('Data successfully moved from A1 to A2!');
}